...
const OldSpotifyContext = createContext<OldSpotifyContextType | undefined>(undefined);

type SpotifyProviderProps = {
  children: ReactNode;
};

export const OldSpotifyProvider: React.FC<SpotifyProviderProps> = ({ children }) => {
...
export const useOldSpotify = () => {
  const context = useContext(OldSpotifyContext);
